This game is a simple cat-and-mouse game. The user can move the cat around the screen with the mouse. If the cat eats the food, the user wins. If the cat collides with the mouse, the user loses.
